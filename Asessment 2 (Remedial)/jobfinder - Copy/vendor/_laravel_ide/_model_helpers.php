...
namespace App\Models {
     ...
     * @property string $deskripsi_lamaran
     * @property mixed $lowongan_id
     * @property mixed $user_id
     * @property int $id
     * @property-read \App\Models\User $user
     * @property-read \App\Models\Lowongan $lowongan
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran whereLowonganId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran whereDeskripsiLamaran($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran whereCvFile($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Lamaran>|Lamaran query()
     ...
     */
    class Lamaran extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Lamaran> $lamarans
     * @property-read int|null $lamarans_count
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan wherePosisi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan wherePerusahaan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan whereLokasiKerja($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan whereDeskripsi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan whereGaji($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Lowongan>|Lowongan query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Lowongan extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
