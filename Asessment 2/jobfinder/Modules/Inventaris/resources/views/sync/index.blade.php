                    ...
                    <table class="min-w-full bg-white border border-gray-300">
                        <thead>
                            <tr class="bg-gray-100 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Nama Pelamar</th>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('sync.edit', $item->id) }}"
                                                class="bg-yellow-500 text-white py-1 px-3 rounded text-xs mr-2 hover:bg-yellow-600">
                                                Edit
                                            </a>

                                            {{-- Tombol Hapus (Menggunakan Form) --}}
                                            <form action="{{ route('sync.destroy', $item->id) }}" method="POST"
